  ...
  return (
    <div className="mt-12 max-w-3xl mx-auto p-4 sm:p-6 bite-container">
      ...
      <p className="text-center text-gray-500 mb-4 sm:mb-6 text-sm sm:text-base font-light">
        ...
        <div
          className={`bg-white rounded-xl shadow-sm border overflow-hidden my-5
            ${
        ...
        >
          ...
          >
            <div className="flex  items-center gap-3">
              <div
                className={`w-8 h-8 sm:w-10 sm:h-10 flex items-center rounded-full justify-center
                  ${
                    selectedSection === "calories"
              ...
              <h2 className="text-xl sm:text-2xl font-thin text-gray-800">
          ...
          >
            <div className="px-4 pb-4 sm:px-5 sm:pb-5 pl-12 sm:pl-16">
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                We'll provide you with <strong>5 different daily calorie targets</strong>{" "}
                ranging from weight loss to weight gain. Compare these options side by
                side to see which aligns best with your health goals.
              </p>
            </div>
          </div>
        </div>
        ...
        <div
          className={`bg-white rounded-xl shadow-sm border overflow-hidden mb-5
            ${
        ...
        >
          ...
          >
            <div className="px-4 pb-4 sm:px-5 sm:pb-5 pl-12 sm:pl-16">
              ...
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                We'll calculate <strong>one precise daily calorie target</strong>{" "}
                specifically calibrated to help you achieve your goal in your timeframe.
              </p>
            </div>
          </div>
        </div>
