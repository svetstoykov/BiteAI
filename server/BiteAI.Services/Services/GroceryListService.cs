...
{
    private const string SystemPrompt = @"You are a grocery list generator. Read a list of meals with IDs, names and recipe paragraphs. Extract ingredients, aggregate duplicates, and output a JSON object matching this C# DTO exactly:
